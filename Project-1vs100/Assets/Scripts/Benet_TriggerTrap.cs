...
public class Benet_TriggerTrap : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.tag == "Enemy")
        {
            ...
            other.GetComponent<Benet_RagdollToggle>().isWalking = false;
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.gameObject.tag == "Enemy")
        {
            ...
            other.GetComponent<Benet_RagdollToggle>().isWalking = true;
        }
    }
